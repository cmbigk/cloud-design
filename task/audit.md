...
##### Verify the deployment. Ask the auditee to show you, the auditor, the use of `aws cli`, and either `kubectl` (for EKS) or relevant ECS commands, as well as `docker ps` if applicable, to answer the following questions.
